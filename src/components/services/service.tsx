...
const Service: FunctionComponent<ServiceProps> = ({
  ...
  return (
    <div className="bg-[radial-gradient(circle_farthest-corner_at_50%_0%,#1e2230_8%,#0e0e0f_54%,#090909_103%)] border border-gray-800 p-4 rounded-3xl cursor-default hover:scale-103 transition-transform flex flex-col gap-2">
